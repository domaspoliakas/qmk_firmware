...
void eq_numlayer_arrow_finished(qk_tap_dance_state_t *state, void *user_data);
void eq_numlayer_arrow_reset(qk_tap_dance_state_t *state, void *user_data);
...
[L_MEDIA] = LAYOUT_ergodox_pretty_80(
    _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______, _______, 
...
[L_GAME] = LAYOUT_ergodox_pretty_80(
