...
[0] = LAYOUT_ergodox_pretty_80(
    FORARROW, KC_1, KC_2, KC_3, KC_4, KC_5, KC_GRV,      KC_PPLS, KC_QUOT, KC_6, KC_7, KC_8, KC_9, FUNCARROW, 
    ...
    KC_LCTL, KC_GRV, KC_NO, KC_LALT, KC_LGUI,                        KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_ENT, 
